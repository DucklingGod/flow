...
- [x] `P10-T06` เตรียม repository delivery controls: GitHub CI, dependency updates, pull-request checklist, release-boundary scan และ initial-publish handoff; initial commit `c701d62` ถูก push และตรวจ remote SHA แล้ว แต่ยังรอบันทึกผล hosted CI และตั้งค่า branch protection บน GitHub

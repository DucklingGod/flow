...
- Hosted GitHub Actions evidence can be inspected through the public API without an authenticated GitHub CLI session. `verify` passed for `3426ab7a904fc88d11f09e387b5fc1fda904df39` at https://github.com/DucklingGod/flow/actions/runs/31161122786; branch-protection settings still require authenticated owner access.
